...
export class FormComponent implements OnInit {
  ...
  private initForm() {
    ...
    this.postForm = new FormGroup({
      ...
      uterine_contractions: new FormControl(uterine_contractions, Validators.required),
      light_decelerations: new FormControl(light_decelerations, Validators.required),
      severe_decelerations: new FormControl(severe_decelerations, Validators.required),
      prolongued_decelerations: new FormControl(prolongued_decelerations, Validators.required),
      abnormal_short_term_variability: new FormControl(abnormal_short_term_variability, Validators.required),
      mean_value_of_short_term_variability: new FormControl(mean_value_of_short_term_variability, Validators.required),
      percentage_of_time_with_abnormal_long_term_variability: new FormControl(percentage_of_time_with_abnormal_long_term_variability, Validators.required),
      mean_value_of_long_term_variability: new FormControl(mean_value_of_long_term_variability, Validators.required),
      ...
      histogram_number_of_peaks: new FormControl(histogram_number_of_peaks, Validators.required),
      histogram_number_of_zeroes: new FormControl(histogram_number_of_zeroes, Validators.required),
      ...
      histogram_variance: new FormControl(histogram_variance, Validators.required),
      histogram_tendency: new FormControl(histogram_tendency, Validators.required),
